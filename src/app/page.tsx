...
export default function Home() {
  return <>
    ...
    <main id="main">
      ...
      <section id="brands" className="brands section-space">
        ...
        <div className="brand-grid">
          <Reveal className="brand-card valley" lift><Image className="brand-bg" src="/brand-virginvalley.png" alt="" fill sizes="(max-width: 760px) 100vw, 48vw" /><span className="brand-scrim valley-scrim" aria-hidden="true" /><div className="brand-card-top"><span>THE TOMATOSKY FAMILY</span><Sprout size={28} strokeWidth={1.3} /></div><div className="brand-name valley-name">Virgin<span>Valley</span><span className="brand-rule" /></div><div className="brand-card-bottom"><span>VirginValley</span><span>A TomatoSky brand</span></div></Reveal>
          <Reveal className="brand-card beauty" delay={0.1} lift><Image className="brand-bg" src="/brand-blackbeauty.png" alt="" fill sizes="(max-width: 760px) 100vw, 48vw" /><span className="brand-scrim beauty-scrim" aria-hidden="true" /><div className="brand-card-top"><span>THE TOMATOSKY FAMILY</span><Sun size={28} strokeWidth={1.3} /></div><div className="brand-name beauty-name">Black Beauty<span>T O M A T O</span></div><div className="brand-card-bottom"><span>Black Beauty Tomato</span><span>A TomatoSky brand</span></div></Reveal>
        </div>
      </section>
    ...
    <footer className="site-footer"><Wordmark light /><p className="footer-legal">TOMATO SKY SAL · Lebanon</p><a href="#main">Back to top ↑</a><span>© {new Date().getFullYear()} TomatoSky</span></footer>
  </>;
}
